...
updateMenuBackState: PropTypes.func,
  ...
  componentDidMount() {
    ...
    Functions._carregaComandas(this,'pedidos-encerrados');
  }
      ...
      <Container style={this.state.styles_aqui.FundoInternas}>
        ...
        <Content style={[this.state.styles_aqui.FundoInternas,{marginTop: -5}]}>
          ...
          <Grid style={this.state.styles_aqui.cabecalho_fundo}>
            <Text style={[this.state.styles_aqui.cabecalho_titulo,{marginLeft:10,marginTop:10}]}>Comandas fechadas</Text>
          </Grid>
          <Grid style={this.state.styles_aqui.cabecalho_fundo}>
          ...
          <List>
            { this.state.data.map((item, index) => (
              <ListItem  style={{borderLeftWidth: 4, borderLeftColor: item.statCor, marginLeft: 0}} key={index} onPress={() => Functions._getPedido(this,item,'PedidoComandaEncerradas')}>
