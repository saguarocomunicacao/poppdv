    ...
    return (
      <Container style={this.state.styles_aqui.FundoInternas}>
        ...
        <Modal
          animationType="slide"
          transparent={true}
          visible={this.state.modalImpressaoCliente}
          onRequestClose={() => {
            console.log('Modal has been closed.');
          }}>
          <View style={{backgroundColor:'rgba(52, 52, 52, 0.8)', padding:20, width: Dimensions.get('window').width, height: Dimensions.get('window').height}}>
            <View style={{backgroundColor:'#ffffff', padding: 10}}>
              ...
              <View style={{ flexDirection:'column', justifyContent: 'space-between', marginBottom:10 }}>
                <View style={{width:"100%", marginLeft: 0, marginBottom:10}}>
                  <Button style={this.state.styles_aqui.btnFundoBranco}  onPress={() => Functions._fecha_modalImpressaoCliente(this)}>
                    <Text style={this.state.styles_aqui.btnFundoBrancoTxt}>NÃO IMPRIMIR</Text>
                  </Button>
                </View>
                <View style={{width:"100%", marginLeft: 0}}>
                  <Button style={style_personalizado.btnGreen} onPress={() => Functions._imprimeComprovanteCliente(this)}>
                    <Text style={style_personalizado.btnGreenTxt}>IMPRIMIR VIA DO CLIENTE?</Text>
                  </Button>
                </View>
              </View>
        ...
        <Modal
          animationType="slide"
          transparent={true}
          visible={this.state.modalImpressaoEstabelecimento}
          onRequestClose={() => {
            console.log('Modal has been closed.');
          }}>
          <View style={{backgroundColor:'rgba(52, 52, 52, 0.8)', padding:20, width: Dimensions.get('window').width, height: Dimensions.get('window').height}}>
            <View style={{backgroundColor:'#ffffff', padding: 10}}>
              ...
              <View style={{ flexDirection:'column', justifyContent: 'space-between', marginBottom:10 }}>
                <View style={{width:"100%", marginLeft: 0, marginBottom:10}}>
                  <Button style={this.state.styles_aqui.btnFundoBranco}  onPress={() => Functions._fecha_modalImpressaoEstabelecimento(this)}>
                    <Text style={this.state.styles_aqui.btnFundoBrancoTxt}>NÃO IMPRIMIR</Text>
                  </Button>
                </View>
                <View style={{width:"100%", marginLeft: 0}}>
                  <Button style={style_personalizado.btnGreen} onPress={() => Functions._imprimeComprovanteEstabelecimento(this)}>
                    <Text style={style_personalizado.btnGreenTxt}>IMPRIMIR VIA DO ESTABELECIMENTO?</Text>
                  </Button>
                </View>
              </View>
          ...
          {(() => {
            if (this.state.carrinho_vazio == true) {
              ...
              return (
                ...
                {(() => {
                  if (this.state.form_realizar_pagamento === false) { } else {
                    return (
