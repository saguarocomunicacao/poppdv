...
public class GertecPrinter {
    ...
    */
     ...
     *
     * */
    public void imprimeImagem( String imagem ) throws GediException {

        // int id = 0;
        // Bitmap bmp;
        try {

            String imagemSet = imagem;
            ...
            final String pureBase64Encoded_imagem = imagemSet.substring(imagemSet.indexOf(",")  + 1);
            final byte[] decoded_imagem = Base64.decode(pureBase64Encoded_imagem, Base64.DEFAULT);
            Bitmap bitmap = BitmapFactory.decodeByteArray(decoded_imagem, 0, decoded_imagem.length);
